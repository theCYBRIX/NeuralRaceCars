...
func _ready() -> void:
	...
	stat_screen.graph.add_series("API Last Response Time", Color.ORANGE, neural_api_client.get_average_response_time)
	stat_screen.graph.add_series("API Average Response Time", Color.YELLOW, neural_api_client.get_last_response_time)
